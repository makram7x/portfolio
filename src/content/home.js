...
// Tools displayed in the Tools section
...
export const heroContent = {
  ...
  firstName: 'Habiba',
  lastName: 'Salah',
  arabicImage: '/HS Arabic 2.png',
  title: 'Digital Media Specialist',
  description: `Passionate about creating impactful digital experiences through
...
export const ctaContent = {
  message: "Have a project in mind? I'd love to hear about it.",
};
