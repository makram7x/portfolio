...
export const UiUxIcon = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="12" cy="11" r="1.5" fill="#7B2CBF"/>
    <circle cx="16" cy="11" r="1.5" fill="url(#iconGradient)"/>
    <rect x="8" y="18" width="14" height="14" rx="2" stroke="url(#iconGradient)" strokeWidth="2" fill="rgba(0,212,255,0.1)"/>
    <rect x="26" y="18" width="14" height="6" rx="1" stroke="url(#iconGradientReverse)" strokeWidth="1.5" fill="rgba(123,44,191,0.1)"/>
    <rect x="26" y="26" width="14" height="6" rx="1" stroke="url(#iconGradientReverse)" strokeWidth="1.5" fill="rgba(123,44,191,0.1)"/>
...
export const GraphicDesignIcon = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M38 8l4 4-4 4" stroke="#00D4FF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
    <path d="M6 36l-2 2 2 2" stroke="#7B2CBF" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
  </svg>
);
...
export const SocialMediaIcon = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="12" y="10" width="24" height="22" rx="2" fill="rgba(0,212,255,0.1)" stroke="url(#iconGradient)" strokeWidth="1.5"/>
    <circle cx="20" cy="18" r="3" stroke="#00D4FF" strokeWidth="1.5"/>
    <path d="M26 16l6 4-6 4V16z" fill="#7B2CBF"/>
...
export const VideoEditingIcon = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="6" y="34" width="4" height="2" rx="0.5" fill="#00D4FF"/>
    <rect x="12" y="34" width="8" height="2" rx="0.5" fill="#7B2CBF"/>
    <rect x="22" y="34" width="6" height="2" rx="0.5" fill="#00D4FF"/>
    <rect x="30" y="34" width="10" height="2" rx="0.5" fill="#7B2CBF"/>
...
export const PhotographyIcon = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="38" cy="18" r="2" fill="#00D4FF"/>
    <path d="M8 18h6" stroke="#7B2CBF" strokeWidth="2" strokeLinecap="round"/>
  </svg>
);
...
export const AnimationIcon = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <circle cx="42" cy="24" r="3" fill="#7B2CBF"/>
    <circle cx="24" cy="42" r="3" fill="#00D4FF"/>
    <circle cx="6" cy="24" r="3" fill="#7B2CBF"/>
  </svg>
);
...
export const BrandingIcon = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M24 4L42 14v20L24 44 6 34V14L24 4z" stroke="url(#iconGradient)" strokeWidth="2.5" fill="rgba(0,212,255,0.05)"/>
...
export const RocketIcon = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M16 4c-4 4-6 10-6 16h12c0-6-2-12-6-16z" stroke="url(#iconGradient)" strokeWidth="2" fill="rgba(0,212,255,0.1)"/>
    <circle cx="16" cy="14" r="2" fill="url(#iconGradient)"/>
    <path d="M10 20l-4 6h4v-6zM22 20l4 6h-4v-6z" stroke="url(#iconGradient)" strokeWidth="1.5" fill="rgba(123,44,191,0.2)"/>
...
export const SparklesIcon = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M6 18l1.5 4.5L12 24l-4.5 1.5L6 30l-1.5-4.5L0 24l4.5-1.5L6 18z" fill="#00D4FF"/>
    <path d="M26 16l1 3 3 1-3 1-1 3-1-3-3-1 3-1 1-3z" fill="#7B2CBF"/>
  </svg>
);
...
export const PhoneIcon = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <rect x="16" y="12" width="16" height="20" rx="1" fill="rgba(0,212,255,0.1)"/>
  </svg>
);
...
export const LinkedInIcon = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="4" y="4" width="40" height="40" rx="8" stroke="url(#iconGradient)" strokeWidth="2.5" fill="rgba(0,212,255,0.05)"/>
...
export const BehanceIcon = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M10 24h9c2.5 0 5 1.5 5 4.5S21.5 33 19 33h-9v-9z" stroke="url(#iconGradient)" strokeWidth="2" fill="rgba(0,212,255,0.1)"/>
...
export const LocationIcon = ({ size = 32 }) => (
  <svg width={size} height={size} viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M16 2C10 2 6 7 6 12c0 8 10 18 10 18s10-10 10-18c0-5-4-10-10-10z" stroke="url(#iconGradient)" strokeWidth="2" fill="rgba(0,212,255,0.1)"/>
...
export const GraduationIcon = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M24 6L4 16l20 10 20-10L24 6z" stroke="url(#iconGradient)" strokeWidth="2.5" fill="rgba(0,212,255,0.1)"/>
...
export const AdobeIcon = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <rect x="4" y="4" width="40" height="40" rx="4" stroke="url(#iconGradient)" strokeWidth="2.5" fill="rgba(0,212,255,0.05)"/>
...
export const FigmaIcon = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <circle cx="17" cy="10" r="6" stroke="#00D4FF" strokeWidth="2.5"/>
    <circle cx="31" cy="10" r="6" stroke="url(#iconGradient)" strokeWidth="2.5" fill="rgba(123,44,191,0.2)"/>
    <circle cx="17" cy="24" r="6" stroke="#7B2CBF" strokeWidth="2.5"/>
    <circle cx="31" cy="24" r="6" stroke="url(#iconGradient)" strokeWidth="2.5" fill="url(#iconGradient)"/>
    <path d="M17 30a6 6 0 100 12 6 6 0 006-6v-6h-6z" stroke="#00D4FF" strokeWidth="2.5"/>
  </svg>
);
...
export const VsCodeIcon = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <path d="M34 8l8 4v24l-8 4-24-12v-8l24-12z" stroke="url(#iconGradient)" strokeWidth="2.5" fill="rgba(0,212,255,0.1)"/>
    <path d="M34 8v32M10 20l14 4-14 4" stroke="url(#iconGradient)" strokeWidth="2.5" strokeLinejoin="round"/>
    <path d="M34 14L18 24l16 10" stroke="#7B2CBF" strokeWidth="2" strokeLinejoin="round"/>
  </svg>
);
...
export const BlenderIcon = ({ size = 48 }) => (
  <svg width={size} height={size} viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg">
    <ellipse cx="28" cy="28" rx="14" ry="12" stroke="url(#iconGradient)" strokeWidth="2.5" fill="rgba(0,212,255,0.05)"/>
